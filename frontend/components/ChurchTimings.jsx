...
export default function ChurchTimings({ schedule: scheduleOverride }) {
  ...
  return (
    <section className="w-full md:w-3/5 bg-[#eaf4ff] p-4 md:p-8 lg:px-12 rounded-lg mx-auto mt-16">
      <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8">
        <div className="mb-8">
          <p className="text-sm uppercase tracking-[0.35em] text-[#1565c0] text-center">Weekly Timetable</p>
          <h2 className="mt-3 text-2xl md:text-4xl font-semibold text-[#0f172a] text-center">Church Weekly Timings</h2>
          ...
          <div className="mt-8 text-sm text-[#475569] border border-[#cbd5e1] rounded-lg inline-block px-4 py-2">
            <p className="font-semibold text-lg md:text-2xl text-[#0f172a]">Active Days</p>
            <p className="text-base md:text-xl">Wed, Fri, Sat, Sun</p>
          </div>
        </div>
