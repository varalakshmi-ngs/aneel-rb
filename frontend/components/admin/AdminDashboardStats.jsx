export default function AdminDashboardStats({ galleryCount, eventsCount, contactsCount, pccCount }) {
  return (
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{galleryCount}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{eventsCount}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-lg font-medium text-gray-900">{contactsCount}</dd>
              </dl>
            </div>
          </div>
        </div>
